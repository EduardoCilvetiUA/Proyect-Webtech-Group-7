...
Ticket.create(user_id: 1, executive_id: 2, supervisor_id: 3, title: "Ticket E", description: "Extra ticket description", priority: "Medium", due_date: Date.today + 8.days, status: "In Progress", star_rating: 2, comment: "Extra ticket comment", execrandoms: 2)